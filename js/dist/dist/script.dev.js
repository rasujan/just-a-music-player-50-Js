...
var cover = document.querySelector("#cover"); // Array of Song titles

var songs = ["funk-me-baby", "spectacular", "the-corporate", "write-your-story"]; // Keep track of songs to determine which song is currently being played

var songIndex = 2; // Update song details
...
function prevSong() {
  ...
  songIndex--; // push back to last index is less then 0
...
function nextSong() {
  ...
  songIndex++; // push to index 0 is last song
...
function updateProgress(e) {
  ...
  progress.style.left = "".concat(progressPercent, "%");
  progressLine.style.width = "".concat(progressPercent, "%");
}
/**
